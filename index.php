...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Pembelian dan Pembayaran Hutang</title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>My </b>App</a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="produk") { echo "active"; } ?>">
              <a href="./?page=produk">
                <i class="fa fa-inbox"></i> <span>Data Produk</span> 
              </a>
            </li>
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="supplier") { echo "active"; } ?>">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="cek_barang") { echo "active"; } ?>">
              <a href="./?page=cek_barang">
                <i class="fa fa-money"></i> <span>Cek Barang</span> 
              </a>
            </li>
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="laporan") { echo "active"; } ?>">
              <a href="./?page=laporan">
            ...
            <li class="">
              <a href="./?page=data_user"><i class="fa fa-user text-warning"></i> Managemen User</a>
            </li>
            <?php endif; ?>
            <li class="treeview">
              <a href="logout.php">
